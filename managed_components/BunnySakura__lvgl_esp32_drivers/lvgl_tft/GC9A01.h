...
// Display offset (gap) configuration
#ifndef GC9A01_X_OFFSET
#define GC9A01_X_OFFSET      2   // Horizontal offset in pixels
#endif

#ifndef GC9A01_Y_OFFSET
#define GC9A01_Y_OFFSET      1   // Vertical offset in pixels
#endif
